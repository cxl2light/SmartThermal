...
public class RxNet {
    ...
    private static final String TAG = "ZeOne=" + RxNet.class.getSimpleName();
    ...
    public static void download(final String url, final String filePath, final DownloadCallback callback) {
        ...
        RetrofitFactory.downloadFile(url, DownloadUtils.getTempFile(url, filePath).length(), listener, new Observer<ResponseBody>() {
            @Override
