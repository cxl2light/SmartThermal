 ...
 * 设备列表页面
 */
public class DeviceSearchHelpMobileActivity extends BaseActivity{

    private static String TAG = "ZeNet=" + DeviceSearchHelpMobileActivity.class.getSimpleName();
...
//        });
    ...
    private void initRecyclerList() {
        ...
        DeviceSearchHelpMobileAdapter adapterOne = new DeviceSearchHelpMobileAdapter();
        ...
        adapterOne.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                switch (position){
                    case 0:
                    case 1:
                        DeviceStartOneActivity.startActivity(DeviceSearchHelpMobileActivity.this,position + 10);
                        break;
                    case 2:
                        DeviceScanPreActivity.startActivity(DeviceSearchHelpMobileActivity.this,position);
                        break;
                }
            }
        });
    ...
    public static void startActivity(Context context) {
        ...
        context.startActivity(new Intent(context, DeviceSearchHelpMobileActivity.class));
    }
