 ...
 * 设备列表页面
 */
public class DeviceSearchHelpDeviceActivity extends BaseActivity{

    private static String TAG = "ZeNet=" + DeviceSearchHelpDeviceActivity.class.getSimpleName();
...
//        });
    ...
    private void initRecyclerList() {
        ...
        mDataList.clear();
        mDataList.add(new QuickBean(1,R.drawable.help_device,R.string.help_device_setting));
        mDataList.add(new QuickBean(2,R.drawable.help_iphone,R.string.help_phone_setting));
        ...
        DeviceSearchHelpDeviceAdapter adapterOne = new DeviceSearchHelpDeviceAdapter();
        ...
        adapterOne.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                switch (position){
                    case 0:
                    case 1:
                        DeviceStartOneActivity.startActivity(DeviceSearchHelpDeviceActivity.this,position);
                        break;
                    case 2:
                        DeviceScanPreActivity.startActivity(DeviceSearchHelpDeviceActivity.this,position);
                        break;
                }
            }
        });
    ...
    public static void startActivity(Context context) {
        ...
        context.startActivity(new Intent(context, DeviceSearchHelpDeviceActivity.class));
    }
