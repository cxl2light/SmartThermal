...
//    private final int default_finished_color = Color.rgb(66, 145, 241); //
    private final int default_finished_color = Color.rgb(255, 76, 27);
    private final int default_unfinished_color = Color.parseColor("#66b6b6b6");
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DensityUtil.dpToPx(context, 18);
        min_size = (int) DensityUtil.dpToPx(context, 100);
